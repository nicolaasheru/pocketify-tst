...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://do-n-done.hstn.me/dondone/public/" target="_blank">Try Do&Done</a>
                    </li>
                    <li class="nav-item">
    ...
    <footer class="footer mt-5 py-3 bg-white">
        <div class="container text-center">
            <span class="text-muted">© <?= date('Y') ?> Pocketify. Made with ❤️ for Students</span>
        </div>
    </footer>
